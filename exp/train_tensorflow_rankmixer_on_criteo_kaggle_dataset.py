...
NUM_TOKENS = 8  # number of tokens after semantic tokenization (T in the paper)
NUM_HEADS = (
    8  # number of attention heads in the token mixer（H in the paper）H must same as T
)
